const ProjectData = [
  ...
  { title:"Pokemon Regional Pokedex Wiki",
    descriptions:["First attempt at using Vue3.",
                "Allows users to view pokemon from each region.",
                "Data fetched from PokeAPI.",
                "Website may take 1-2 minute to load."],
    technologies:"Vue3, Jest",
    githubLink:"https://github.com/Jonaspng/Pokedex-Wiki",
    websiteLink:"https://pokedex-wiki.vercel.app/"},
  { title: "GPA Tracker",
